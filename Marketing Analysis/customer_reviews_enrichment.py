...
def fetch_data_from_sql():
    ...
    conn_str = (
        ...
        "Server=LAPTOP-N8HBMIKG\SQLEXPRESS01;"  # Specify your SQL Server instance
...
customer_reviews_df.to_csv('fact_customer_reviews_with_sentiment(Code).csv', index=False)
